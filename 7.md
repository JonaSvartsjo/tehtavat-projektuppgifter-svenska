...
I denna uppgift ska du göra ett program som skapar databasen `bikes_2023.db` för år 2023. Data som ska ingå i databasen finns i CSV‑format som [publicerats av HRT](https://www.avoindata.fi/data/fi/dataset/helsingin-ja-espoon-kaupunkipyorilla-ajatut-matkat). 
...
PDF-rapporten ska innehålla koden till ditt program.
