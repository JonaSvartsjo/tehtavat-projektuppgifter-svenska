...
* som ett SQL-schema (`CREATE TABLE` -kommandon för att skapa databasen)
* som ett grafiskt databasschema (du kan använda verktyget [dbdiagram.io](https://dbdiagram.io/))
