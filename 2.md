...
* Ilmoituksessa näkyy myytävän tavaran tiedot (otsikko, kuvaus, hinta) sekä yksi tai useampi kuva.
...
* SQL-skeemana (`CREATE TABLE` -komennot tietokannan luomiseen)
* graafisena tietokantakaaviona (voit käyttää työkalua [dbdiagram.io](https://dbdiagram.io/))

Lisäksi selosta lyhyesti jokaisesta toiminnosta, miten niissä tarvittava tietosisältö voidaan tallentaa tietokantaan.

## Palautusohje

PDF-raportin tulee sisältää SQL-skeema, tietokantakaavio sekä toimintojen selostukset.
