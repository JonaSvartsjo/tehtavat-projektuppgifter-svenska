...
Tehtäväsi on laatia koodi, joka sisältää seuraavat tietokantaa käyttävät funktiot.
...
Sivuhuomio: Nämä tiedot eivät vaikuta uskottavilta, koska tämä tarkoittaisi, että pisin matkan pituus on 655 kilometriä ja pisin matkan kesto on 73 päivää.
...
| Asema                 | Alkaneet matkat| Päättyneet matkat | Ero |
|-------------------------|------:|--------:|--------:|
...
PDF-raportin tulee sisältää koodi, jossa on yllä olevat funktiot ja kutsut, jotka tuottavat esimerkeissä näkyvät tulokset.
