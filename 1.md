...
Tehtäväsi on laatia Python- tai R-kielinen kooditiedosto, joka sisältää seuraavat tietokantaa käyttävät funktiot.
...
Nämä tiedot eivät vaikuta uskottavilta, koska tämä tarkoittaisi, että pisin matkan pituus on 655 kilometriä ja pisin matkan kesto on 72 päivää.
