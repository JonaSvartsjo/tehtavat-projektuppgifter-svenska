...
Tehtäväsi on selvittää, miten MongoDB-tietokannasta haetaan tietoa ohjelmoimalla. Kurssin materiaalissa ei ole tietoa tästä, mutta voit käyttää nettilähteitä ja tekoälyä. Voit toteuttaa koodin Python- tai R-kielellä.
...
Sinun tulee laatia koodi, joka etsii vastaukset seuraaviin kysymyksiin:
...
PDF-raportin tulee sisältää ohjelmasi koodi sekä sen antamat vastaukset yllä oleviin kysymyksiin.
